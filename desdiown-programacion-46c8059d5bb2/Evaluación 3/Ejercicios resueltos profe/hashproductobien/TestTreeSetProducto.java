...
public class TestTreeSetProducto {
    ...
    public static void main(String args[]) {
        ...
        System.out.println("hash de carne: "+carne.hashCode());
        System.out.println("hash de res: "+res.hashCode());
// Definir un TreeSet 
       // Set<Producto> lista = new HashSet();
        Set<Producto> lista = new TreeSet();
        lista.add(pan);
        lista.add(leche);
        lista.add(manzanas);
        lista.add(brocoli);
