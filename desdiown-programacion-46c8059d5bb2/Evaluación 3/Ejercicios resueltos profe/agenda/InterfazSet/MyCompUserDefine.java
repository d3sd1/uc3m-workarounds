...
public class MyCompUserDefine {
    ...
    public static void main(String a[]) {
        ...
        nameComp.add(new Empl("Crish", 3000));
        nameComp.add(new Empl("John", 3000));
        nameComp.add(new Empl("Crish", 4000));
        ...
        salComp.add(new Empl("Crish", 4000));
        salComp.add(new Empl("John", 2000));
        salComp.add(new Empl("Crish", 4500));
        salComp.add(new Empl("Tom", 5400));
        for (Empl e : salComp) {
            System.out.println(e);
        }
    }
