            ...
            <div class="page-content page-content-popup">
                <div class="page-content-fixed-header">
                    ...
                    <ul class="page-breadcrumb">
						...
						<li><?php echo $lang['path.colors'] ?></li>
                    </ul>
                    <!-- END BREADCRUMBS -->
                ...
                <div class="page-sidebar-wrapper">
                    ...
                    <div class="page-sidebar navbar-collapse collapse">
                        ...
                        <?php echo $admin->menu('frontpagecolors'); ?>
                        <!-- END SIDEBAR MENU -->
                    </div>
                    <!-- END SIDEBAR -->
                </div>
                <div class="page-fixed-main-content">
                    <h1><?php echo $lang['frontpage.colors.conversor'] ?></h1>
                                        <div class="row">
                                            <div class="col-md-3"><input type="text" id="valueRGB" placeholder="255,255,255" onchange="javascript:rgbToHex()"></div>
                                            <div class="col-md-3"><input type="text" id="valueRGBFinal" disabled placeholder="#FFFFFF"></div>
                                            <div class="col-md-3"><input type="text" id="valueHEX" placeholder="#FFFFFF" onchange="javascript:hexToRgb()"></div>
                                            <div class="col-md-3"><input type="text" disabled id="valueHEXFinal" placeholder="255,255,255"></div>
                                        </div>
					<h1><?php echo $lang['frontpage.colors.h1'] ?></h1>
					<?php
					if(isset($_POST['updateColors']))
					{
						echo '<div class="alert alert-success fade in alert-dismissable" style="margin-top:18px;">
								...
								<strong>'.$lang['frontpage.colors.updatesuccess'].'</strong> '.$lang['frontpage.colors.updatesuccess.desc'].'
							</div>';
							$db->query('UPDATE web_design SET value="'.implode(',',$core->hex2rgb($_POST['index_bgcolor_header'])).','.$_POST['index_bgcolor_header_op'].'" WHERE keyname="index_bgcolor_header"');
							$db->query('UPDATE web_design SET value="'.implode(',',$core->hex2rgb($_POST['index_bgcolor_testimonials'])).','.$_POST['index_bgcolor_testimonials_op'].'" WHERE keyname="index_bgcolor_testimonials"');
							$db->query('UPDATE web_design SET value="'.implode(',',$core->hex2rgb($_POST['index_bgcolor_banners'])).','.$_POST['index_bgcolor_banners_op'].'" WHERE keyname="index_bgcolor_banners"');
							$db->query('UPDATE web_design SET value="'.implode(',',$core->hex2rgb($_POST['index_bgcolor_howyumiworks'])).','.$_POST['index_bgcolor_howyumiworks_op'].'" WHERE keyname="index_bgcolor_howyumiworks"');
							$db->query('UPDATE web_design SET value="'.implode(',',$core->hex2rgb($_POST['index_bgcolor_howyumiworks_blows'])).','.$_POST['index_bgcolor_howyumiworks_blows_op'].'" WHERE keyname="index_bgcolor_howyumiworks_blows"');
							$db->query('UPDATE web_design SET value="'.implode(',',$core->hex2rgb($_POST['index_bgcolor_howyumiworks_blowsnonactive'])).','.$_POST['index_bgcolor_howyumiworks_blowsnonactive_op'].'" WHERE keyname="index_bgcolor_howyumiworks_blowsnonactive"');
							$db->query('UPDATE web_design SET value="'.implode(',',$core->hex2rgb($_POST['index_bgcolor_joinnow'])).','.$_POST['index_bgcolor_joinnow_op'].'" WHERE keyname="index_bgcolor_joinnow"');
							$db->query('UPDATE web_design SET value="'.implode(',',$core->hex2rgb($_POST['index_bgcolor_footer'])).','.$_POST['index_bgcolor_footer_op'].'" WHERE keyname="index_bgcolor_footer"');
					}
					?>
                    <form class="form-horizontal" method="post" action="<?php echo URL ?>/frontpage/colors">
						<input type="hidden" name="updateColors" value="true">
					  <div class="form-group">
						<label class="control-label col-sm-2" for="header"><?php echo $lang['frontpage.colors.header'] ?>:</label>
						<div class="col-sm-1">
						  <input type="color" style="width: 100%" name="index_bgcolor_header" value="<?php $elementColor = explode(',',$db->query('SELECT value FROM web_design WHERE keyname="index_bgcolor_header"')->fetch_row()[0]); $elementColorOp = $elementColor[3]; unset($elementColor[3]); echo $core->rgb2hex($elementColor); ?>"/>
						</div>
						<label class="control-label col-sm-2" for="opacity"><?php echo $lang['frontpage.colors.opacity'] ?>:</label>
						<div class="col-sm-1">
						  <input type="number" min="0" max="1" step="0.05" name="index_bgcolor_header_op" value="<?php echo $elementColorOp; ?>"/>
						</div>
					  </div>
					  <div class="form-group">
						<label class="control-label col-sm-2" for="testimonials"><?php echo $lang['frontpage.colors.testimonials'] ?>:</label>
						<div class="col-sm-1">
						  <input type="color" style="width: 100%" name="index_bgcolor_testimonials" value="<?php $elementColor = explode(',',$db->query('SELECT value FROM web_design WHERE keyname="index_bgcolor_testimonials"')->fetch_row()[0]); $elementColorOp = $elementColor[3]; unset($elementColor[3]); echo $core->rgb2hex($elementColor); ?>"/>
						</div>
						<label class="control-label col-sm-2" for="opacity"><?php echo $lang['frontpage.colors.opacity'] ?>:</label>
						<div class="col-sm-1">
						  <input id="background-color" type="number" name="index_bgcolor_testimonials_op" min="0" max="1" step="0.05" value="<?php echo $elementColorOp; ?>"/>
						</div>
					  </div>
					  <div class="form-group">
						<label class="control-label col-sm-2" for="banners"><?php echo $lang['frontpage.colors.banners'] ?>:</label>
						<div class="col-sm-1">
						  <input type="color" style="width: 100%" name="index_bgcolor_banners" value="<?php $elementColor = explode(',',$db->query('SELECT value FROM web_design WHERE keyname="index_bgcolor_banners"')->fetch_row()[0]); $elementColorOp = $elementColor[3]; unset($elementColor[3]); echo $core->rgb2hex($elementColor); ?>"/>
						</div>
						<label class="control-label col-sm-2" for="opacity"><?php echo $lang['frontpage.colors.opacity'] ?>:</label>
						<div class="col-sm-1">
						  <input id="background-color" type="number" min="0" max="1" step="0.05" name="index_bgcolor_banners_op" value="<?php echo $elementColorOp; ?>"/>
						</div>
					  </div>
					  <div class="form-group">
						<label class="control-label col-sm-2" for="howyumiworks"><?php echo $lang['frontpage.colors.howyumiworks'] ?>:</label>
						<div class="col-sm-1">
						  <input type="color" style="width: 100%" name="index_bgcolor_howyumiworks" value="<?php $elementColor = explode(',',$db->query('SELECT value FROM web_design WHERE keyname="index_bgcolor_howyumiworks"')->fetch_row()[0]); $elementColorOp = $elementColor[3]; unset($elementColor[3]); echo $core->rgb2hex($elementColor); ?>"/>
						</div>
						<label class="control-label col-sm-2" for="opacity"><?php echo $lang['frontpage.colors.opacity'] ?>:</label>
						<div class="col-sm-1">
						  <input id="background-color" type="number" name="index_bgcolor_howyumiworks_op" min="0" max="1" step="0.05" value="<?php echo $elementColorOp; ?>"/>
						</div>
					  </div>
					  <div class="form-group">
						<label class="control-label col-sm-2" for="howyumiworksactiveblow"><?php echo $lang['frontpage.colors.howyumiworksblows'] ?>:</label>
						<div class="col-sm-1">
						  <input type="color" style="width: 100%" name="index_bgcolor_howyumiworks_blows" value="<?php $elementColor = explode(',',$db->query('SELECT value FROM web_design WHERE keyname="index_bgcolor_howyumiworks_blows"')->fetch_row()[0]); $elementColorOp = $elementColor[3]; unset($elementColor[3]); echo $core->rgb2hex($elementColor); ?>"/>
						</div>
						<label class="control-label col-sm-2" for="opacity"><?php echo $lang['frontpage.colors.opacity'] ?>:</label>
						<div class="col-sm-1">
						  <input id="background-color" type="number" name="index_bgcolor_howyumiworks_blows_op" min="0" max="1" step="0.05" value="<?php echo $elementColorOp; ?>"/>
						</div>
					  </div>
					  <div class="form-group">
						<label class="control-label col-sm-2" for="howyumiworksnonactiveblow"><?php echo $lang['frontpage.colors.howyumiworksblowsnonactive'] ?>:</label>
						<div class="col-sm-1">
						  <input type="color" style="width: 100%" name="index_bgcolor_howyumiworks_blowsnonactive" value="<?php $elementColor = explode(',',$db->query('SELECT value FROM web_design WHERE keyname="index_bgcolor_howyumiworks_blowsnonactive"')->fetch_row()[0]); $elementColorOp = $elementColor[3]; unset($elementColor[3]); echo $core->rgb2hex($elementColor); ?>"/>
						</div>
						<label class="control-label col-sm-2" for="opacity"><?php echo $lang['frontpage.colors.opacity'] ?>:</label>
						<div class="col-sm-1">
						  <input id="background-color" type="number" name="index_bgcolor_howyumiworks_blowsnonactive_op" min="0" max="1" step="0.05" value="<?php echo $elementColorOp; ?>"/>
						</div>
					  </div>
					  <div class="form-group">
						<label class="control-label col-sm-2" for="joinnow"><?php echo $lang['frontpage.colors.joinnow'] ?>:</label>
						<div class="col-sm-1">
						  <input type="color" style="width: 100%" name="index_bgcolor_joinnow" value="<?php $elementColor = explode(',',$db->query('SELECT value FROM web_design WHERE keyname="index_bgcolor_joinnow"')->fetch_row()[0]); $elementColorOp = $elementColor[3]; unset($elementColor[3]); echo $core->rgb2hex($elementColor); ?>"/>
						</div>
						<label class="control-label col-sm-2" for="opacity"><?php echo $lang['frontpage.colors.opacity'] ?>:</label>
						<div class="col-sm-1">
						  <input id="background-color" type="number" name="index_bgcolor_joinnow_op" min="0" max="1" step="0.05" value="<?php echo $elementColorOp; ?>"/>
						</div>
					  </div>
					  <div class="form-group">
						<label class="control-label col-sm-2" for="footer"><?php echo $lang['frontpage.colors.footer'] ?>:</label>
						<div class="col-sm-1">
						  <input type="color" style="width: 100%" name="index_bgcolor_footer" value="<?php $elementColor = explode(',',$db->query('SELECT value FROM web_design WHERE keyname="index_bgcolor_footer"')->fetch_row()[0]); $elementColorOp = $elementColor[3]; unset($elementColor[3]); echo $core->rgb2hex($elementColor); ?>"/>
						</div>
						<label class="control-label col-sm-2" for="opacity"><?php echo $lang['frontpage.colors.opacity'] ?>:</label>
						<div class="col-sm-1">
						  <input id="background-color" type="number" name="index_bgcolor_footer_op" min="0" max="1" step="0.05" value="<?php echo $elementColorOp; ?>"/>
						</div>
					  </div>
					  <div class="form-group">
					  <label class="control-label col-sm-2"></label>
						<div class="col-sm-4">
						<button style="margin: 0 auto" type="submit" class="btn btn-primary"><?php echo $lang['frontpage.colors.update'] ?></button>
						</div>
					  </div>
					</form>
                </div>
...
function windowUpdated()
{
		...
		jQuery(function ($) {
			startTimer(<?php echo $config['admin.session.timeout'] ?>, $('#logoutTimer'));
                ...
                function rgbToHex() {
                    ...
                    if(hex != "")
                    {
                        $("#valueRGBFinal").val(hex);
                        $("#valueRGBFinal").css("background-color", "");
                    }
                    else
                    {
                        $("#valueRGBFinal").css("background-color", "red");
                    }
                }
                function hexToRgb() {
                    var hex = $("#valueHEX").val();
                    hex = hex.replace('#','');
 ...
 result = 'rgb('+r+','+g+','+b+')';
                     if(hex != "")
                    {
                        $("#valueHEXFinal").val(result);
                        $("#valueHEXFinal").css("background-color", "");
                    }
                    else
                    {
                        $("#valueHEXFinal").css("background-color", "red");
                    }
                }
