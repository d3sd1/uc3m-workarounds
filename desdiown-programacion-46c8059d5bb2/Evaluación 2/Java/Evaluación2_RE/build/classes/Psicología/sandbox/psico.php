...
<div id="header" style="background-image: url(<?php echo URL ?>/images/psicobg.jpg)">
	<div class="mainnav">
		<div class="container">
...
<div class="content_wrapper">
	...
	{
		?>
		<div id="brand" style="background-color: rgba(<?php echo $db->query('SELECT value FROM web_design WHERE keyname="index_bgcolor_testimonials"')->fetch_row()[0] ?>) !important">
                    <div class="container">
                                            ...
                                            <div class="item-inner">
                                                <div class="product-wrapper">
                                                    <div class="thumb-wrapper">
                                                        <a href="#"><img class="img-responsive" src="<?php echo URL ?>/images/brands/3docean.png" alt="Brand imgae"/></a>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
