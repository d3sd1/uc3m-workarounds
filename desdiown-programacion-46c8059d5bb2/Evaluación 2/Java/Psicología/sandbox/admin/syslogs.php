...
<html lang="<?php echo $lang['meta.lang'] ?>">
    ...
    <body class="" data-toggle="context" data-target="#context-menu">
        ...
        <div class="container-fluid">
			...
			<li><?php echo $lang['path.syslogs'] ?></li>
                    </ul>
                    <!-- END BREADCRUMBS -->
                                    ...
                                    <div class="mt-element-list">
                                        <div class="mt-list-head list-todo red">
                                            <div class="list-head-title-container">
                                                <h3 class="list-title"><?php echo $lang['syslogs.title'] ?></h3>
                                                        ...
                                                        <div class="list-todo-item dark">
                                                            <a class="list-toggle-container collapsed" data-toggle="collapse" data-parent="#'.$fileName.'" onclick=" " href="#'.$fileName.'Var" aria-expanded="false">
                                                                <div class="list-toggle done uppercase">
                                                                    ...
                                                                    <div class="badge badge-default pull-right bold">'.$lang['syslogs.lastModify'].': '.date('d/m/Y - H:i:s', filemtime(BASEDIR.'../../'.$fileNameFull)).'</div>
                                                                </div>
                                                            </a>
