...
<html lang="<?php echo $lang['meta.lang'] ?>">
    ...
    <head>
        ...
        <link href="<?php echo URL ?>/assets/global/plugins/bootstrap-fileinput/bootstrap-fileinput.css" rel="stylesheet" type="text/css" /><!-- END PAGE LEVEL PLUGINS -->
    ...
    <body class="" data-toggle="context" data-target="#context-menu">
        ...
        <div class="container-fluid">
			...
			<li><?php echo $lang['path.frontpagevideo'] ?></li>
                    </ul>
                    <!-- END BREADCRUMBS -->
                ...
                <div class="page-sidebar-wrapper">
                    ...
                    <div class="page-sidebar navbar-collapse collapse">
                        ...
                        <?php echo $admin->menu('indexvideo'); ?>
                        <!-- END SIDEBAR MENU -->
                    </div>
                    <!-- END SIDEBAR -->
                </div>
                        ...
                        <div class="col-md-12">
                            <div class="portlet light portlet-fit bordered">
                                    <div class="portlet-title">
                                        <div class="caption">
                                            <i class="fa fa-file-video-o font-dark"></i>
                                            <span class="caption-subject font-dark bold uppercase"><?php echo $lang['frontpage.videos.old'] ?></span>
                                        </div>
                                    </div>
                                    <div class="portlet-body">
                                        <div class="table-scrollable">
                                            <table class="table table-bordered table-hover">
                                                <thead>
                                                    <tr>
                                                        <th> <?php echo $lang['frontpage.videos.old.vidname'] ?> </th>
                                                        <th> <?php echo $lang['frontpage.videos.old.user'] ?> </th>
                                                        <th> <?php echo $lang['frontpage.videos.old.time'] ?> </th>
                                                        <th> <?php echo $lang['frontpage.videos.old.download'] ?> </th>
                                                    </tr>
                                                </thead>
                                                <tbody>
                                                    <?php
                                                    foreach(scandir(BASEDIR.'/assets/video/indexBg') as $fileName)
                                                    {
                                                        $vidOpts = explode('_',$fileName);
                                                        if(count($vidOpts) > 1)
                                                        {
                                                            if($fileName != '.' && $fileName != '..' && $fileName != 'desktop.ini')
                                                            {
                                                                echo '<tr>
                                                                        <td> '.$fileName.' </td>
                                                                        <td> <b>'.$vidOpts['3'].'</b> ('.$vidOpts['2'].') </td>
                                                                        <td> '.$core->timeElapsed($vidOpts['4']).' </td>
                                                                        <td> <a href="'.BASEURL.'/assets/video/indexBg/'.$fileName.'" target="downloadLastVid">'.$lang['frontpage.videos.old.download'].'</a> </td>
                                                                    </tr>';
                                                            }
                                                        }
                                                        elseif($fileName != '.' && $fileName != '..' && $fileName != 'desktop.ini')
                                                        {
                                                            echo '<tr>
                                                                        <td> '.$fileName.' </td>
                                                                        <td> N/A </td>
                            ...
                            <div class="portlet light form-fit bordered">
                                <div class="portlet-title">
                                    <div class="caption">
                                        <i class="fa fa-file-video-o font-green"></i>
                                        <span class="caption-subject font-green sbold uppercase"><?php echo $lang['frontpage.video.h1'] ?></span>
                                    </div>
                                </div>
                                <div class="portlet-body form">
                                    ...
                                    {
                                        $target_file = BASEDIR.'/assets/video/indexBg/background.mp4';
                                        $uploadOk = 1;
                                        $imageFileType = pathinfo(basename($_FILES['newVideoBg']['name']),PATHINFO_EXTENSION);
                                        if (file_exists($target_file)) {
                                            rename($target_file,BASEDIR.'/assets/video/indexBg/background_old_'.ADMIN_ID.'_'.ADMIN_NAME.'_'.time().'.mp4');
                                        }
                                        if($imageFileType != "mp4") {
                                            echo '<div class="alert alert-danger">
                                            <strong>'.$lang['frontpage.video.errorUpload'].'</strong> '.$lang['frontpage.video.errorUploadExt.desc'].'
                                          </div>';
                                            $uploadOk = 0;
                                        }
                                        if ($_FILES["fileToUpload"]["size"] > 536870912) {
                                            echo '<div class="alert alert-danger">
                                          <strong>'.$lang['frontpage.video.errorUpload'].'</strong> '.$lang['frontpage.video.errorUploadSize.desc'].'
                                        </div>';
                                            $uploadOk = 0;
                                        }
                                        if ($uploadOk != 0) {
                                            if (move_uploaded_file($_FILES["newVideoBg"]["tmp_name"], $target_file)) {
                                                echo '<div class="alert alert-success">
                                          <strong>'.$lang['frontpage.video.successUpload'].'</strong> '.$lang['frontpage.video.successUpload.desc'].'
                                        </div>';
                                            } else {
                                                echo '<div class="alert alert-danger">
                                          <strong>'.$lang['frontpage.video.errorUpload'].'</strong> '.$lang['frontpage.video.errorUpload.desc'].'
                                        </div>';
                                            }
                                        }
                                    }
                                    ...
                                    <form id="indexBgVideo" class="form-horizontal form-bordered" enctype="multipart/form-data" method="POST">
                                        <div class="form-body">
                                            <div class="form-group">
                                                <label class="control-label col-md-3"><?php echo $lang['frontpage.video.url'] ?></label>
                                                <div class="col-md-3">
                                                    <div class="fileinput fileinput-new" data-provides="fileinput">
                                                        <div class="input-group input-large">
                                                            ...
                                                            <span class="input-group-addon btn default btn-file">
                                                                <span class="fileinput-new"> <?php echo $lang['frontpage.video.select'] ?> </span>
                                                                <span class="fileinput-exists"> <?php echo $lang['frontpage.video.change'] ?> </span>
                                                                <input type="hidden" name="formSentUpdateBg" value="true"><input type="file" name="newVideoBg" value="lol" accept="video/mp4"> </span>
                                                            <a href="javascript:;" class="input-group-addon btn red fileinput-exists" data-dismiss="fileinput"> <?php echo $lang['frontpage.video.remove'] ?> </a>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="row">
                                                <div class="col-md-offset-3 col-md-9">
                                                    <a href="javascript:document.getElementById('indexBgVideo').submit();"  class="btn green">
                                                        <i class="fa fa-check"></i> <?php echo $lang['frontpage.video.submit'] ?></a>
                                                    <a href="javascript:;" class="btn btn-outline grey-salsa"><?php echo $lang['frontpage.video.cancel'] ?></a>
                                                </div>
                                            </div>
                                        </div>
