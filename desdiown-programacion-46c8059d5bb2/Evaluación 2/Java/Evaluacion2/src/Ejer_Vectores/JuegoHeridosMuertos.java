...
public class JuegoHeridosMuertos {
    ...
    {
        JuegoHeridosMuertos.createGame();
    }
    public static void createGame()
    {
        JuegoHeridosMuertos caller = new JuegoHeridosMuertos();
        ...
        int secretNum = new JuegoHeridosMuertos().generateSecretNum(startNum, endNum);
